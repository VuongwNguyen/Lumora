const ERROR_TYPE_DESCRIPTIONS = Object.freeze({
  ...
  story_action_fail: 'Story renderer không thể thực thi cinematic action.',
  story_playback_fail: 'Story timeline không thể tiếp tục phát.',
  story_emotion_save_fail: 'Không thể lưu ý định cảm xúc của Story.',
